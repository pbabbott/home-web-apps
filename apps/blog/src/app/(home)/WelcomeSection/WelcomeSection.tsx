...
export default function WelcomeSection() {
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-screen-lg gap-6 py-6">
      ...
      <div className="grid grid-cols-2 gap-8">
        <div>
          ...
          <div className="flex items-center justify-center flex-col mb-4">
            <Image
              src="/qBitTorrent_Architecture.excalidraw.svg"
        ...
        <div>
          ...
          <TransparentPanel color="secondary">
            <Typography variant="body1" component="p">
              Whether its building efficient pipelines, automating workflows, or
              designing maintainable systems, the goal is simple: share clear,
              practical insights that engineers can actually use.
            </Typography>
          </TransparentPanel>
        </div>
      </div>
