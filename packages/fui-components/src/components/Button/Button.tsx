...
const getColorClasses = (variant: ButtonVariant, color: ButtonColor) => {
  const colors = {
    ...
    'accent-purple': {
      ...
      outlined:
        'border-accent-purple-300 text-accent-purple-300 hover:bg-accent-purple-300 hover:text-neutral-50',
    ...
    'accent-falcon': {
      ...
      outlined:
        'border-accent-falcon-400 text-accent-falcon-400 hover:bg-accent-falcon-400 hover:text-neutral-50',
...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    'px-4 py-2 transition-colors font-monobit text-button uppercase tracking-[.1em]';
