...
export const getOnePasswordValue = async (vault: string, secretName: string, secretKey: string) => {
  console.log(`🌐 Getting secret value from 1Password for ${secretName} with key ${secretKey}`)
