...
export const setEnvironmentVariables = () => {
  ...
  process.env['SECTION_ANOTHER_COOL_SUB_TYPE'] =
    expectedData.expectedAnotherCoolSubTypeString;
  process.env['SECTION_DETAILS_MY_PROPERTY'] =
    expectedData.expectedSubSubTypeString;
};
